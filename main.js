...
let exchangeRate;
if (currency.fromCurrency === currency.conversionCurrency) { //if both currencies are equal then show the same amount(no need of conversion)
...
else { //if the user does'nt select correctly from the options
